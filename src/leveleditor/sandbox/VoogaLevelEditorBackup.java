...
import leveleditor.LevelEditorModel;
...
public class VoogaLevelEditorBackup extends JFrame {
    ...
    protected LevelEditorModel myModel;
    protected VoogaLevelEditorBackup myView;
    protected LevelEditorController myController;
    private GridBagConstraints myConstraints;
    public JPanel myCanvaspane, mySpritepane;
    private JMenuBar myMenuBar = new JMenuBar();
    
    public VoogaLevelEditorBackup(LevelEditorModel model, 
