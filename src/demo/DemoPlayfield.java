...
public class DemoPlayfield extends GameObject2D {
    ...
    public void initResources() {
        ...
        Tile temp1 = new Tile(this, new DefaultPhysicsAttribute());
        ...
        ActionDecorator block2 = new BreakableDecorator(new Tile(this, new DefaultPhysicsAttribute()), 2);
        ...
        AutoInUseAutoNotInUseItem poison = new AutoInUseAutoNotInUseItem(this, new DefaultPhysicsAttribute());
      ...
      ActionDecorator otherBar = new FallingDecorator(new Tile(this, new DefaultPhysicsAttribute()), 1000);
